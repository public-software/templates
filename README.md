...
4. A pull request here goes through the same gates as any repository: the rendered kinds must build, and the agent review (`suite / policy`) reads the change against the rubric.
